...
export const SHIPPING_ORDERS_REQUEST = 'SHIPPING_ORDERS_REQUEST';
export const SHIPPING_ORDERS_SUCCESS = 'SHIPPING_ORDERS_SUCCESS';
export const SHIPPING_ORDERS_FAIL = 'SHIPPING_ORDERS_FAIL';
